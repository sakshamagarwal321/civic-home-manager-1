...
type MaintenancePaymentInsert = Database['public']['Tables']['maintenance_payments']['Insert'];
type MaintenancePaymentRow = Database['public']['Tables']['maintenance_payments']['Row'];
...
export const useMaintenancePayments = () => {
  ...
  const createPaymentMutation = useMutation({
    mutationFn: async (paymentData: CreatePaymentData) => {
      // Convert our interface to Supabase's expected type
      const insertData: MaintenancePaymentInsert = {
